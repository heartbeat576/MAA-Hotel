    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      {/* Rooms Images */}
       ...
       <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
           ...
           <div className='flex flex-col flex-wrap md:flex-row items-start md:item-center gap-4 md:gap-10 text-gray-500'>
              <div className='flex flex-col'>
       ...
       <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guests will be accommodated on the ground floor based on availability. This cozy two-bedroom apartment offers an authentic city vibe. The quoted price covers two guests; please specify the number of guests in the provided field to receive an accurate rate for larger groups.</p>
       </div>
       ...
       <div className='flex flex-col items-start gap-4'>
        ...
        <button className='px-6 py-2.5 mt-4 rounded text-white bg-primary hover:bg-primary-dull transition-all cursor-pointer'>Contact Us</button>
